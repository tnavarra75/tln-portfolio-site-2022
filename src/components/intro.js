    ...
    <section id="intro" className='intro' aria-label='intro'>
      <div className='intro__wrap'>
        ...
        <div className='intro__ctas'>
          <Link to="/#projects" className="intro__cta intro__cta--view">view projects<BsArrowRightShort /></Link>
          <a className="intro__cta intro__cta--download" href='/TL_resume_2022.pdf' target="_blank" rel="noreferrer">résumé <FiDownload /></a>
        </div>
